...
const ASTRO_PRODUCTS=[
  {id:'birth-basic',name:'출생차트 성향 분석',price:1500,desc:'성격, 기질, 감정 패턴처럼 본인의 기본 구조를 중심으로 보는 리딩'},
  {id:'love-marriage',name:'연애/결혼운',price:1500,desc:'금성, 화성, 달, 7하우스 흐름을 중심으로 보는 관계 리딩'},
  {id:'career-money',name:'직업/재물운',price:1500,desc:'태양, 수성, 목성, 토성, 2·10하우스 흐름을 보는 현실 리딩'},
  {id:'yearly',name:'올해 운세',price:1500,desc:'현재 트랜짓과 출생차트의 주요 각도를 보는 연간 리딩'},
...
function astrologyResultVisualHTML(flow){if(!flow||!flow.chart)return '';const transit=flow.transit||calculateTransit(new Date());const tj={date:transit&&transit.date?new Date(transit.date):new Date(),transit,aspects:calculateTransitAspects(flow.chart,transit)};return `<section class="astro-panel astro-today-visual"><div class="astro-section-title">리딩 기준 차트</div><div class="astro-text">바깥의 금색 행성은 출생차트, 안쪽의 파란 행성은 리딩 시점의 트랜짓이에요.</div><div class="astro-wheel-wrap compact">${renderNatalChartWheel(flow.chart,tj)}</div></section>`;}
